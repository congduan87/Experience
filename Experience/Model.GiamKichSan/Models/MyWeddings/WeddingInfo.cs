...
namespace Model.GiamKichSan.Models.MyWeddings
{
    [Table(name: "WeddingHappy_Wedding")]
    public class Wedding_Entity
    {
        [Key]
    ...
    public class WeddingCouple_Entity
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Int64 ID { get; set; }
    ...
    public class Suggestion_Entity
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Int64 ID { get; set; }
    ...
    public class FileUpload_Entity
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Int64 ID { get; set; }
    ...
    public class WeddingVideo_Entity
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Int64 ID { get; set; }
    ...
    public class GuestConnect_Entity
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Int64 ID { get; set; }
